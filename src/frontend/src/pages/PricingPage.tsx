...
export default function PricingPage() {
  ...
  return (
    <AppShell
      ...
      subheading="Pick a plan that matches how often you ride. You can always switch later."
      actions={heroActions}
    >
      <PageSection title="Choose a plan">
              ...
              <div key={plan.planId} className={styles.card}>
                ...
                <dl className={styles.details}>
                  ...
                  <div>
                    ...
                    <dd>
                      {plan.eBikeSurchargePerMinute &&
                      plan.eBikeSurchargePerMinute > 0
                ...
                {plan.subscriptionFee !== null && (
                  <p className={styles.subscriptionNote}>
                    All rides are included in your monthly subscription—no
                    per-trip charges.
                  </p>
                )}
                <button
